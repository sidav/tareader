...
func (r *ModelRenderer) scanlineFillTriangle(x0, y0, x1, y1, x2, y2 int32, z0, z1, z2 float64, color byte) {
...
func (r *ModelRenderer) HLineZBufNoArr(x1, x2, y int32, color byte, z1, z2 float64) {
	if x1 > x2 {
		x1, x2 = x2, x1
		z1, z2 = z2, z1
	}
